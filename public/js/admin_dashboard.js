...
// Get references to all necessary DOM elements. This makes the code cleaner and prevents
// multiple redundant calls to document.getElementById().
...
const deleteUserModalTrigger = document.getElementById('deleteUserModal'); // Correct ID for the modal
 ...
 * This is used to populate quick stats and the tracking list.
 */
...
function fetchTrackingIdsForEmailSelect() {
    ...
    .then(trackings => {
        ...
        trackings.forEach(tracking => {
            ...
            option.value = tracking.trackingId; // Use trackingId for the email pre-fill
...
function renderUsersTable(users) {
    ...
    document.querySelectorAll('.delete-user-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            // The modal trigger button with id="deleteUserModalTrigger" is the link. The modal itself has id="deleteUserModal".
            // The logic to open the modal should use the modal instance.
...
// Document ready and Materialize initialization
